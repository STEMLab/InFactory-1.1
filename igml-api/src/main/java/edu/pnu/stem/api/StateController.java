...
public class StateController {
	...
	public void createState(@PathVariable("docId") String docId, @PathVariable("id") String id,
	...
	public void updateState(@PathVariable("docId") String docId, @PathVariable("id") String id,
							@RequestBody ObjectNode json, HttpServletRequest request, HttpServletResponse response) {
		try {
			IndoorGMLMap map 		= Container.getDocument(docId);
			String duality 			= null;
	...
	public void getState(@PathVariable("docId") String docId, @PathVariable("id") String id,
	...
	public void deleteState(@PathVariable("docId") String docId, @PathVariable("id") String id,
							@RequestBody ObjectNode json, HttpServletRequest request, HttpServletResponse response) {
		try {
			IndoorGMLMap map = Container.getDocument(docId);
			assert map != null;
