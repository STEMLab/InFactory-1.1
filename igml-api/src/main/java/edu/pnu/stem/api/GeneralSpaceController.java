...
public class GeneralSpaceController {
	...
	public void createGeneralSpace(@PathVariable("id") String id, @RequestBody ObjectNode json,
		...
		try {
			...
			*/
			c = GeneralSpaceDAO.createGeneralSpace(map, parentId, id, name, description,
	...
	public void getGeneralSpace(@PathVariable("docId") String docId,@PathVariable("id") String id,
	...
	public void updateGeneralSpace(@PathVariable("docId") String docId,@PathVariable("id") String id,
	...
	public void deleteGeneralSpace(@PathVariable("docId") String docId,@PathVariable("id") String id,
								   @RequestBody ObjectNode json, HttpServletRequest request, HttpServletResponse response) {
		try {
			IndoorGMLMap map = Container.getDocument(docId);
			assert map != null;
