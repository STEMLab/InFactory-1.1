...
public class GeneralSpaceDAO {
	public static void deleteGeneralSpace(IndoorGMLMap map, String id) {
		GeneralSpace target = (GeneralSpace)map.getFeature(id);
	...
	public static GeneralSpace readGeneralSpace(IndoorGMLMap map, String id) {
		GeneralSpace target = null;
		try {
			target = (GeneralSpace)map.getFeature(id);
		}
	...
	public static GeneralSpace updateGeneralSpace(IndoorGMLMap map, String parentId, String id, String name, String description, Geometry geometry, String duality, List<String>partialboundedBy) {
		GeneralSpace result = new GeneralSpace(map,id);
		GeneralSpace target = (GeneralSpace)map.getFeature(id);
		...
		map.removeFeature(id);
		map.setFeature(id, "GeneralSpace", result);
		
		return result;
	}
	public static GeneralSpace createGeneralSpace(IndoorGMLMap map, String parentId, String id, String name, String description, Geometry geometry, String duality, List<String> partialBoundedBy, String classType, String functionType, String usageType ) {
		...
		GeneralSpace newFeature = new GeneralSpace(map, id);
		
		if(map.hasFutureID(id)){
			newFeature = (GeneralSpace)map.getFutureFeature(id);
			//map.removeFutureID(id);
		}
		else{
			map.setFutureFeature(id, newFeature);
		}
		map.setFeature(id, "GeneralSpace", newFeature);
	...
	public static GeneralSpace createGeneralSpace(IndoorGMLMap map, String parentId, String id, String geometry, String duality) {
